...
const HeadBottom = () => {
  ...
  return (
    <div className="flex relative justify-center px-10 border-t border-b">
        <div onClick={()=>{setMenu(!menu)}} className="block p-3 md:hidden basis-1/3">
          <MenuIcon className="h-6" />
        </div>
      <nav className={`flex flex-col justify-evenly md:items-center md:flex md:flex-row basis-2/3 ${menu ? "visible h-[auto]" : "invisible md:visible md:h-auto h-[0]"}`}>
      ...
      <div className="hidden justify-center items-center md:flex basis-1/3">
        ...
        <ul className="flex ml-3 space-x-3 cursor-pointer">
          <Link
            ...
            className="hover:text-[#081828]"
          >
            <FacebookIcon />
          </Link>
          <Link
            href={"https://www.instagram.com/nazmul6390/"}
            className="hover:text-[#081828]"
          >
            <InstagramIcon />
          </Link>
          <Link
            href={"https://twitter.com/NLNazmuL1"}
            className="hover:text-[#081828]"
          >
            <TwitterIcon />
          </Link>
          <Link
            href={"https://github.com/nnhasan0290"}
            className="hover:text-[#081828]"
          >
            <GitHubIcon />
          </Link>
